              ...
              {socials.map(({ label, href, Icon }) => (
                <li key={label}>
                  <a
                    ...
                    aria-label={label}
                    className="flex h-10 w-10 items-center justify-center rounded-full border border-line text-secondary transition-all hover:border-signal-cyan/40 hover:text-primary"
                  >
